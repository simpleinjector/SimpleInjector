...
..\packages\ReportGenerator.2.5.1\tools\ReportGenerator.exe "-reports:..\coverage\coverage.xml" "-targetdir:..\coverage\report" "-filters:-*.Tests*;" "-historydir:coverage\history"
