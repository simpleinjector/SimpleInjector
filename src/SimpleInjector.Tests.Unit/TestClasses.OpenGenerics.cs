...
namespace SimpleInjector.Tests.Unit
{
    ...
    public sealed class ComponentDependingOn<TDependency>(TDependency dependency)
    {
    ...
    public class GenericTypeWithLoggerDependency<T>(ILogger logger) : IGeneric<T>;
    ...
    public class OpenGenericWithPredicateWithClassConstraint<T> : IOpenGenericWithPredicate<T> where T : class;
