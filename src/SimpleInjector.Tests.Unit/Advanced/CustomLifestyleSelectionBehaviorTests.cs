namespace SimpleInjector.Tests.Unit.Advanced
{
    ...
    public class CustomLifestyleSelectionBehaviorTests
    {
        ...
        public void RegisterCollectionGeneric_WithOverriddenLifestyleSelectionBehavior_ReturnsInstancesBasedOnTheirExpectedLifestyle()
        {
            ...
            // Act
            container.Collection.Register<ILog>(new[] { typeof(SqlLogger), typeof(FileLogger) });
        ...
        public void RegisterCollectionNonGeneric_WithOverriddenLifestyleSelectionBehavior_ReturnsInstancesBasedOnTheirExpectedLifestyle()
        {
            ...
            // Act
            container.Collection.Register(typeof(ILog), new[] { typeof(SqlLogger), typeof(FileLogger) });
